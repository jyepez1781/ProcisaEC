      ...
      <div className="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200 flex flex-col md:flex-row md:items-end gap-4">
        ...
        <div className="flex items-center border rounded-lg overflow-hidden bg-white h-fit self-end">
          ...
          <button
            ...
            className={`px-4 py-2 text-xs font-medium flex items-center gap-2 ${grouping === 'TYPE' ? 'bg-purple-600 text-white' : 'text-slate-600 hover:bg-slate-50'}`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 text-xs font-medium flex items-center gap-2 ${grouping === 'USER' ? 'bg-purple-600 text-white' : 'text-slate-600 hover:bg-slate-50'}`}
          >
